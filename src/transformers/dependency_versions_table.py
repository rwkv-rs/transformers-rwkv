...
deps = {
    ...
    "fastapi": "fastapi",
    "filelock": "filelock",
    "flash-linear-attention[flash-rwkv]": "flash-linear-attention[flash-rwkv] @ git+https://github.com/rwkv-rs/fla-rwkv.git@606752b7dff79eb326eeebf2d046102027da5306",
    "fugashi": "fugashi>=1.0",
