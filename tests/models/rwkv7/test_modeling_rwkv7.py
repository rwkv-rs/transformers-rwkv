...
def test_rwkv7_runtime_provenance_is_fork_pinned_in_fresh_process() -> None:
    ...
    distributions = {
        "flash-linear-attention": PinnedVcsDistribution(
            ...
            "606752b7dff79eb326eeebf2d046102027da5306",
        ),
        "flash-rwkv": PinnedVcsDistribution(
            ...
            "8b3d08a9a9430df23fb9da9b35fb0aa625faa1fb",
        ),
    }
    ...
    assert provenance == {
        ...
        "requirement": "flash-linear-attention[flash-rwkv] @ git+https://github.com/rwkv-rs/fla-rwkv.git@606752b7dff79eb326eeebf2d046102027da5306",
        "revision": "606752b7dff79eb326eeebf2d046102027da5306",
        "source_kind": "vcs",
    }
